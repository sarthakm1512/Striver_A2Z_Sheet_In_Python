#Question Link: https://leetcode.com/problems/design-a-food-rating-system/?envType=daily-question&envId=2025-09-17
"""
...
class FoodRatings:
    ...
    def __init__(self, foods: List[str], cuisines: List[str], ratings: List[int]):
        ...
        for food, cuisine, rating in zip(foods, cuisines, ratings):
            ...
            # Push (-rating, food) for heap ordering
    ...
    def highestRated(self, cuisine: str) -> str:
        ...
        # Ensure top of heap matches current rating
        while heap:
            rating, food = heap[0]  # peek at top
            if -rating == self.food_to_rating[food]:
                return food
            # Outdated entry -> remove it
            heapq.heappop(heap)
